...
public class WebEventLogListener extends BaseClass implements WebDriverListener {
    ...
    public void beforeGet(WebDriver driver, String url) {
        ...
        log.atInfo().log("Trying to navigate to "+url);
    }

    @Override
    public void afterGet(WebDriver driver, String url) {
        WebDriverListener.super.afterGet(driver, url);
        log.atInfo().log("Successfully to navigated to "+url);
    ...
    public void beforeGetTitle(WebDriver driver) {
        ...
        log.atInfo().log("Trying to get the current window page title");
